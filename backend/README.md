...
```json
{
  "tokenIn": "CCW67TSZV3SSS2HXMBQ5JFGCKJNXKZM7UQUWUZPUTHXSTZLEO7EJJJUD",
...
curl -X POST http://localhost:4000/api/makers/register \
  -H "Content-Type: application/json" \
  -d '{"stellarAddress":"GAHJJJKMOKYE4RVPZEWZTKH5FVIIA5T2EMWNA5YQBDAGTBU7BVXD9YWZ","name":"Test MM","signerPublicKey":"'$(head -c 32 /dev/urandom | xxd -p)'","supportedPairs":[{"tokenIn":"CCW67TSZV3SSS2HXMBQ5JFGCKJNXKZM7UQUWUZPUTHXSTZLEO7EJJJUD","tokenOut":"CDOIV56NSBNVNZN4XPTOT7JVRK6AW4RUISEPYUZYIIKMVIY7X3OH4S5X"}]}'
```
...
```json
{"type":"priceLevels","message":{"tokenIn":"CCW67TSZV3SSS2HXMBQ5JFGCKJNXKZM7UQUWUZPUTHXSTZLEO7EJJJUD","tokenOut":"CDOIV56NSBNVNZN4XPTOT7JVRK6AW4RUISEPYUZYIIKMVIY7X3OH4S5X","levels":[{"quantity":"100000","price":"0.9245"},{"quantity":"1000000","price":"0.9240"}]}}
```
...
curl -X POST http://localhost:4000/api/quote \
  -H "Content-Type: application/json" \
  -d '{"tokenIn":"CCW67TSZV3SSS2HXMBQ5JFGCKJNXKZM7UQUWUZPUTHXSTZLEO7EJJJUD","tokenOut":"CDOIV56NSBNVNZN4XPTOT7JVRK6AW4RUISEPYUZYIIKMVIY7X3OH4S5X","amountIn":"500000","takerAddress":"GAHJJJKMOKYE4RVPZEWZTKH5FVIIA5T2EMWNA5YQBDAGTBU7BVXD9YWZ"}'
```
